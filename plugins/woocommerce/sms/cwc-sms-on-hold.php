...
if ( ! class_exists( 'WC_SMS_On_Hold' ) ) :

/**
 * 새로운 주문에 SMS 보내기
 */
class WC_SMS_On_Hold extends sms4wpAddOn {
	private $section;
	/**
	 * Constructor
	 */
	function __construct() {
		$this->section = 'wc_on_hold';
	...
	function get_form_title() {
		$title = __( 'On Hold order', 'woocommerce' );
	...
	function get_form_description() {
		$description = __( 'Order On Hold SMS.', 'woocommerce' );
