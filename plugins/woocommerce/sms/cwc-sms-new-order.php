...
if ( ! class_exists( 'WC_SMS_New_Order' ) ) :

/**
 * 새로운 주문에 SMS 보내기
 */
class WC_SMS_New_Order extends sms4wpAddOn {
	private $section;
	/**
	 * Constructor
	 */
	function __construct() {
		$this->section = 'wc_new_order';
	...
	function get_form_description() {
		$description = __( 'New order SMS are sent to the recipient list when an order is received.', 'woocommerce' );
