...
if ( ! class_exists( 'WC_SMS_Failed_Order' ) ) :

/**
 * 새로운 주문에 SMS 보내기
 */
class WC_SMS_Failed_Order extends sms4wpAddOn {
	private $section;
	/**
	 * Constructor
	 */
	function __construct() {
		$this->section = 'wc_failed_order';

		// Triggers for this sms
		add_action( 'woocommerce_order_status_failed', array( $this, 'trigger' ), 10, 2 );
	...
	function get_form_description() {
		$description = __( 'Order Failed SMS.', 'woocommerce' );
...
return new WC_SMS_Failed_Order();
